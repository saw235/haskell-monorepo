...
import Adidas.AntiFingerprint (setupAntiFingerprinting, setupAntiFingerprintingWithProfile, randomizeUserAgent, humanizeScrolling, mockComprehensiveFingerprint)
import Adidas.FingerprintConfig (FingerprintProfile(..), defaultProfile, firefoxProfile, chromeProfile, safariProfile)
